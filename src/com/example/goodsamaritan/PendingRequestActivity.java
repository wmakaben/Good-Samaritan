...
public class PendingRequestActivity extends FragmentActivity implements ActionBar.TabListener {
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case android.R.id.home:
			...
			// is shown. Use NavUtils to allow users to navigate up one level in the application 
			// structure. For more details, see the Navigation pattern on Android Design:
